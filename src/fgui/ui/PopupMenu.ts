...
export class PopupMenu {
    ...
    public addItem(caption: string, handler?: Function, caller ?: any): GButton {
        var item: GButton = this.createItem(caption, handler, caller);
        this._list.addChild(item);

        return item;
    }

    public addItemAt(caption: string, index: number, handler?: Function, caller ?: any): GButton {
        var item: GButton = this.createItem(caption, handler, caller);
    ...
    private createItem(caption: string, handler?: Function, caller ?: any): GButton {
