...
export class UIConfig {
    //Default font name
    public static defaultFont: string = "defaultFont";
    ...
    public static modalLayerColor: Color = new Color(0.2, 0.2, 0.2, 0.2);
    ...
    */
    ...
    public static defaultLinkClass: string = "fgui-link";
