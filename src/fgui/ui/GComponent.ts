...
import { clamp, Constructor } from "../utils/ToolSet";
...
export class GComponent extends GObject {
    ...
    public get displayListContainer(): UIElement {
    ...
    public getChildren(): ReadonlyArray<GObject> {
    ...
    public constructFromResource2(objectPool: GObject[], poolIndex: number): void {
        ...
        if (hitTestId) {
            ...
            //     this._element.hitArea = new PixelHitTest(pi.pixelHitTestData, i1, i2, this.sourceWidth, this.sourceHeight);
        }
        else if (i1 != 0 && i2 != -1) {
            //todo
            //this._element.hitArea = new ShapeHitTest(this.getChildAt(i2).element);
        }
